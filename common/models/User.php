 ...
 */
class User extends BaseUser implements IdentityInterface, UserCredentialsInterface
{
    ...
    {
        try {
            $user = self::find()->where(['username' => $username, 'is_deleted' => false])->one();
            if ($user) {
